    ...
    <div class="container-fluid">
        <div class="row layout-header">
            <div class="col-sm-12 header-content">
                <h1>
                    <i class="fas fa-bullhorn fa-xs text-white2"></i> Puntos
                </h1>
                <span class="subtitle">
            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <div>
                            <a class="btn btn-success" href="{{ route('points.create') }}">
                                <span class="icon">
                    ...
                    <table class="table tableD">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->point_user->name }}</td>
                                <td>{{ $item->point_user->lastname }}</td>
                                <td>{{ $item->point_user->email }}</td>
                                <td>{{ $item->point_user->company }}</td>
                                <td>{{ getCountry($item->point_user->country) }}</td>
                                <td>{{ $item->points }}</td>
                                <td>{{ $item->detail }}</td>
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('points.edit', $item->id) }}">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['points.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
